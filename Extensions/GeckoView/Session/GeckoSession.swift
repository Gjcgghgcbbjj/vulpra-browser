...
public class GeckoSession {
    ...
    public func updateSettings(_ settings: GeckoSessionSettings) {
        ...
        // #2: setLocale removed — it's a global runtime setting, not per-session.
        // Calling it on every updateSettings/open was redundant (N tabs = N IPCs
        // for the same value). Locale is set once at app startup.
    ...
    public func open(windowId: String? = nil) {
        ...
        // #2: setLocale removed from per-session open — see updateSettings comment.
