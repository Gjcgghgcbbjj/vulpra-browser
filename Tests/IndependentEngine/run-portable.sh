...
python3 "$ROOT/Tests/IndependentEngine/test_a2_cold_start_gate.py"
python3 "$ROOT/Tests/IndependentEngine/test_scroll_gate_contract.py"
python3 "$ROOT/Tests/IndependentEngine/test_benchmark_contract.py"
python3 "$ROOT/Tests/IndependentEngine/test_event_coalescing_contract.py"
