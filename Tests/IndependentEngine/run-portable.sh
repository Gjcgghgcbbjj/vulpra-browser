...
python3 "$ROOT/Tests/IndependentEngine/test_a2_cold_start.py"
python3 "$ROOT/Tests/IndependentEngine/test_memory_pressure.py"
python3 "$ROOT/Tests/IndependentEngine/test_process_pool_policy.py"
